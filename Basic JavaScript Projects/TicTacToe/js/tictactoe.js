...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'O') {
            ...
            disableClick();
            //This function awaits 1 second before the computer places an image and enables click
            setTimeout(function() { computersTurn(); }, 1000);
        }
        //Returning true in seeded for our computersTurn() function to work.
        return true;
    }
    //this function results in a random square being selected by the computer
    function computersTurn() {
        //This boolean in needed for our while loop
        let success = false;
        //this variable stores a random number 0-8
        let pickASquare;
        //This condition allows our while loop to keep trying if a suare is selected already
        while (!success) {
...
function resetGame() {
    ...
    for (let i = 0; i < 9; i++) {
        ...
        //this removes our elements bakcgorund image
        square.style.backgroundImage = '';
    }
    //this resets our aray so it is empty and we can start over
    selectedSquares = [];
}