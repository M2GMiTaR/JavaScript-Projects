...
function Input_Decimal(dot) {
    ...
    if (!Calculator.Display_Value.includes(dot)) {
        //We are saying that if the Display_Value does not contain decimal point
        //we want to add a decmila point
...
function Handle_Operator(Next_Operator) {
    ...
    } else if (operator) { //checks if an operator already ecists
